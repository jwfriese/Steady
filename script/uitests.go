...
func main() {
	...
	uiTestCommand := exec.Command("xcodebuild", "-verbose", "test", "-workspace", "FleetUI.xcworkspace", "-scheme", "FleetUI", "-destination", "platform=iOS Simulator,OS=9.3,name=iPhone 6")
